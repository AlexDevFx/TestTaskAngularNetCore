        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<GoodDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<GoodDto[]>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<GoodDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return _observableOf<GoodDto[]>(<any>null);
    }
}
...
export class OrdersServiceProxy {
     ...
     * @return Success
     */
    create(inputOrder: OrderDto | null | undefined): Observable<OrderDto> {
     ...
     * @return Success
     */
    get(orderId: number | null | undefined): Observable<OrderDto[]> {
...
export class OrderDto implements IOrderDto {
    ...
    shouldBeDelivered: boolean | undefined;
    deliveryDate: moment.Moment | undefined;
    goods: GoodDto[] | undefined;
